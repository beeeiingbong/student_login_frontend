...
const RegisterForm= ({ dispatchRegisterAction })=> {
    ...
    const handleOnSubmit = (event) =>{
        ...
        if(isFromInvalid()) updateErrorFlags()
    ...
    const isFromInvalid = ()=> (!firstName || !lastName ||!password || !email);
    ...
    return (
        <React.Fragment>
            ...
            <form noValidate onSubmit={handleOnSubmit}>
                ...
                <div className="form-group">
                <label htmlform="email1">Email Address</label>
            ...
            <button type="submit" className="btn btn-primary mr-2">
                Register | <i className="fas fa-times-plus"></i>
            </button>
